...
<main class="sync_backend_entries">
  ...
  <label for="tab1"><i class="fas fa-bed"></i> Hotel Room</label>
  <?php
    }
  ...
  ?>
  <label for="tab2"><i class="fas fa-car"></i> Car Rent</label>
  <?php
    }
  ...
  ?>  
  <label for="tab3"><i class="fas fa-utensils"></i> Restaurant Reservation</label>
  <?php
    }
    if($sync_hotel_enable==true) {
  ?>   
