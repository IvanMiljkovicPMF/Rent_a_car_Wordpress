...
function easyncShowHotelFieldsMetaBox() {
    ...
    <p>
        ...
        <br>
        <input style="width:100%;" type="number" min="0" name="easync_hotel[price]" id="easync_hotel[price]" class="regular-text" 
  ...
  <table id="room-images-repeatable-fieldset-one" width="30%">
    ...
    <p>
        <label for="easync_hotel[writemsg]">Enable 'Others' Option</label>
        <br>
    ...
    <p>
        ...
        <br>
        <textarea style="width:100%;" name="easync_hotel[notes]" rows="5" cols="30" id="easync_hotel[notes]" style="width:500px;"><?php if(!empty($meta['notes'])) echo $meta['notes']; ?></textarea>
    </p>
...
function easyncSaveHotelMeta( $post_id ) {   
    ...
    $new['price'] = stripslashes( strip_tags( intval($Items['price']) ) );
