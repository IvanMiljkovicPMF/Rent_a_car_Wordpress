...
function easyncCssAndJs() {
    ...
    //wp_register_script('jquery_js', plugins_url('/js/jquery-3.3.1.min.js', __FILE__));
    ...
    // wp_register_style('dataTables_style', plugins_url('/css/dataTables.min.css', __FILE__));
    ...
    // wp_register_style('material_style', plugins_url('/css/material.min.css', __FILE__));
    // wp_enqueue_style('material_style');
    // wp_register_style('d_material_style', plugins_url('/css/dataTables.material.min.css', __FILE__));
    // wp_enqueue_style('d_material_style');
    // wp_register_script('d_material_js', plugins_url('/js/dataTables.material.min.js', __FILE__));
    // wp_enqueue_script('d_material_js');
   ...
   // wp_enqueue_media();
    ...
    wp_register_style('jquery-slider-ui_style', plugins_url('/css/jquery-ui.theme.min.css', __FILE__));
    ...
    // wp_localize_script('form_js', 'sync_plugin_directory', array(
...
function easyncLoadCustomWpAdminStyle($hook) {
    if(($hook != 'easync-booking_page_easync-entries') && ($hook != 'easync-booking_page_easync-settings') && ($hook != 'toplevel_page_easync-booking')) {
            return;
    }
    easyncEnqueue();
}
...
function easyncEnqueue() {
   ...
   if (!wp_style_is( 'fontawesome', 'enqueued' )) {
    ...
    //wp_enqueue_script('example_ajax_script');
