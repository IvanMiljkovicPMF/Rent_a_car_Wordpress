...
function easyncShowCarFieldsMetaBox() {
    ...
    <p>
        <label for="easync_car[number_room]">Total cars</label>
        <br>
    ...
    <p>
        ...
        <br>
        <input style="width:100%;" style="width:100%;" type="number" min="0" name="easync_car[price]" id="easync_car[price]" class="regular-text" 
